...
__DEFINE__(1658410141927, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1658410141928,"./event-store":1658410141929}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1658410141928, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1658410141929, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1658410141928,"./utils":1658410141930}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1658410141930, function(require, module, exports) {
...
return __REQUIRE__(1658410141927);
})()
